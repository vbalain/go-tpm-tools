...
import (
	...
	pb "github.com/google/go-tpm-tools/mytools/communication/secure/proto/connect"
	"github.com/google/go-tpm-tools/mytools/showwg0"
)

var (
	serverAddr = flag.String("addr", "192.168.0.1:51820", "VPN Wireguard subnet/server address in the format of host:port")
)

func RequestPSK(serverAddr string) {
	var opts []grpc.DialOption
	opts = append(opts, grpc.WithTransportCredentials(insecure.NewCredentials()))
	fmt.Println("client(secure): dialing to: ", serverAddr)
